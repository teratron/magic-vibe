...
8. **Hook Execution:** When creating or updating a plan, the agent must check for and execute any relevant hooks as defined in the `.magic-vibe/rules/hooks/` or `.magic-vibe/ai/hooks/` directory, according to the rules in `core/hooks.md`.

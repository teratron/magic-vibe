...
VERSION_FILE=".magic-vibe/tools/version.json"
...
if [ -f "$DOCS_EN_README" ]; then
    ...
    sed -i "s/Magic Vibe.*$/Magic Vibe](https:\/\/img.shields.io\/badge\/Magic%20Vibe-v${magic_vibe_version}-orange.svg)](..\/\.magic-vibe\/rules\/)/g" "$DOCS_EN_README"
    ...
    sed -i "s/- \*\*Magic Vibe System:\*\* .*/- **Magic Vibe System:** v${magic_vibe_version}/g" "$DOCS_EN_README"
...
if [ -f "$DOCS_RU_README" ]; then
    ...
    sed -i "s/Magic Vibe.*$/Magic Vibe](https:\/\/img.shields.io\/badge\/Magic%20Vibe-v${magic_vibe_version}-orange.svg)](..\/\.magic-vibe\/rules\/)/g" "$DOCS_RU_README"
    ...
    sed -i "s/- \*\*Система Magic Vibe:\*\* .*/- **Система Magic Vibe:** v${magic_vibe_version}/g" "$DOCS_RU_README"
...
echo "   🔧 Magic Vibe System: v${magic_vibe_version}"
